...
class Paciente(Usuario):
    def __init__(self, id, nome, email, senha):
        super().__init__(id, nome, email, senha, tipo_usuario='Paciente')

class Profissional(Usuario):
    def __init__(self, id, nome, email, senha, crm, especialidade):
        super().__init__(id, nome, email, senha, tipo_usuario='Profissional')
        self.crm = crm
